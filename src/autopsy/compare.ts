...
export function compareBills(previous: ExtractedBill, current: ExtractedBill): AutopsyResult {
  ...
  // ⚡ Bolt: Consolidated 3 filter+reduce chains and 1 map-building loop into a
  // single pass to eliminate intermediate array allocations and redundant iterations.
  let disputable = 0;
  let optimization = 0;
  let unexplained = 0;
