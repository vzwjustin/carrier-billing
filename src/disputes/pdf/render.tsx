    ...
    <View style={styles.table}>
      ...
      {packet.affectedLines.map((row, idx) => {
        ...
        return (
          ...
          >
            <Text style={[styles.tableCell, styles.colMdn]}>
              {row.mdnDisplay}
            </Text>
...
function PageFooter({ packet }: { packet: DisputePacket }): ReactElement {
  return (
    <View style={styles.footer} fixed>
      <Text>
        Generated by CarrierAudit · {packet.generatedDateDisplay}
      </Text>
      <Text
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.badgeRow}>
          ...
          <View style={styles.chip}>
            <Text style={styles.chipText}>
              Confidence {packet.confidencePercent}%
            </Text>
          </View>
        </View>
        ...
        <View style={styles.metaGrid}>
          ...
          <MetaCell
            ...
            value={packet.billingPeriodDisplay}
          />
          <MetaCell
            label="Account(s)"
            value={
          ...
          <MetaCell
            ...
            value={packet.requestedCreditDisplay}
          />
