  ...
  evaluate: ({ bill, today }) => {
    ...
    bill.accounts.forEach((account, accountIndex) => {
      account.lines.forEach((line, lineIndex) => {
        ...
        // Optimized: Avoid spread operator in Math.max to prevent call stack size limits on large arrays
        ...
        // Optimized: Avoid spread operator in Math.min to prevent call stack size limits on large arrays and eliminate intermediate map array
