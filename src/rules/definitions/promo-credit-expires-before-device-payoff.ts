  ...
  evaluate: ({ bill, today }) => {
    ...
    bill.accounts.forEach((account, accountIndex) => {
      account.lines.forEach((line, lineIndex) => {
        ...
        // ⚡ Bolt: Eliminate array spread in Math.max to prevent call stack issues on large arrays
        ...
        // ⚡ Bolt: Eliminate array spread in Math.min to prevent call stack issues on large arrays
