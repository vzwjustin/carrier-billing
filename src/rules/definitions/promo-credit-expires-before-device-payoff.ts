  ...
  evaluate: ({ bill, today }) => {
    ...
    bill.accounts.forEach((account, accountIndex) => {
      account.lines.forEach((line, lineIndex) => {
        ...
        // ⚡ Bolt Performance Optimization: Replace spread operator with `.reduce()`
        // to avoid `Maximum call stack size exceeded` errors and Edge Runtime CI build failures.
        ...
        // ⚡ Bolt Performance Optimization: Replace spread operator with `.reduce()`
        // to avoid allocating an intermediate array and to prevent potential stack overflow.
