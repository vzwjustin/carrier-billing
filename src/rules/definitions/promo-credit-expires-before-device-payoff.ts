      ...
      account.lines.forEach((line, lineIndex) => {
        ...
        for (const d of line.dpp_installments) {
          if (d.remaining_payments !== null && d.remaining_payments > 0) {
            dppMonthsLeft = Math.max(dppMonthsLeft, d.remaining_payments);
          }
        }
        ...
        // ⚡ Bolt: Using reduce instead of spread operator to avoid Array map allocation and Max Call Stack Size Exceeded errors.
