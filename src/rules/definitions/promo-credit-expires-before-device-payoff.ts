  ...
  evaluate: ({ bill, today }) => {
    ...
    bill.accounts.forEach((account, accountIndex) => {
      account.lines.forEach((line, lineIndex) => {
        ...
        // ⚡ Bolt: Single-pass loop to avoid intermediate array allocations and spread operator
        ...
        // ⚡ Bolt: Single-pass loop avoids multiple reduce/map passes and intermediate allocations
