  ...
  evaluate: ({ bill, today }) => {
    ...
    bill.accounts.forEach((account, accountIndex) => {
      account.lines.forEach((line, lineIndex) => {
        ...
        // Bolt Optimization: Calculate max remaining payments in a single pass to avoid array mapping/filtering
        // and prevent Edge Runtime call stack limits from large array spreads in Math.max().
