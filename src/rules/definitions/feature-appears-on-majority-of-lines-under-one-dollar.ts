  ...
  evaluate: ({ bill }) => {
    ...
    bill.accounts.forEach((account, accountIndex) => {
      ...
      for (const [, occurrences] of byName) {
        ...
        // ⚡ Bolt: Single pass over occurrences to calculate total, track max cents, and map line indexes.
        // This avoids intermediate array allocations and prevents RangeError when spreading into Math.max() on large accounts.
        let total = 0;
