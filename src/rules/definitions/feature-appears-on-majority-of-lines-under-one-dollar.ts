      ...
      for (const [, occurrences] of byName) {
        ...
        findings.push({
          ...
          evidence: {
            ...
            // ⚡ Bolt: Using reduce to avoid spread operator on potentially unbounded arrays,
            // which prevents RangeError on large fleets and avoids intermediate allocations.
