      ...
      for (const [, occurrences] of byName) {
        ...
        findings.push({
          ...
          evidence: {
            ...
            // ⚡ Bolt: Using reduce instead of Math.max(...map) to avoid an intermediate
            // array allocation and prevent RangeError: Maximum call stack size exceeded
            // on massive fleets where occurrences can number in the tens of thousands.
