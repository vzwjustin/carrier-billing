      ...
      for (const [, occurrences] of byName) {
        ...
        findings.push({
          ...
          evidence: {
            ...
            // Optimization: avoid spreading potentially unbounded arrays to prevent RangeError
            // (Maximum call stack size exceeded) and skip the intermediate .map() allocation
