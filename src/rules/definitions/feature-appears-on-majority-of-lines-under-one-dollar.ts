      ...
      for (const [, occurrences] of byName) {
        ...
        findings.push({
          ...
          evidence: {
            ...
            // ⚡ Bolt: Use reduce instead of spread on a mapped array to avoid intermediate allocation
            // and prevent RangeError: Maximum call stack size exceeded on large fleets.
