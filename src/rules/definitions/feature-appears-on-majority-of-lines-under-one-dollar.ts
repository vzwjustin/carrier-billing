      ...
      for (const [, occurrences] of byName) {
        ...
        findings.push({
          ...
          evidence: {
            ...
            // PERF: use reduce instead of map+spread to avoid intermediate arrays and call stack limits
            per_line_max_cents: occurrences.reduce((max, o) => (o.monthly_cents > max ? o.monthly_cents : max), -Infinity),
          },
        });
      }
    });
