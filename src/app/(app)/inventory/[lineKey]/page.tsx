...
export default async function InventoryLinePage({
  ...
  // Performance optimization: Single pass loop avoids intermediate map/filter arrays and Math spread
  ...
  const deltaCents =
    validBaseCount >= 2 && minBase !== null && maxBase !== null ? maxBase - minBase : null;
