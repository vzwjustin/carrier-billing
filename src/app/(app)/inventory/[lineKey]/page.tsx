...
export default async function InventoryLinePage({
  ...
  // Optimization: use a single pass loop instead of `.map().filter()` chains
  // with `Math.min`/`Math.max` and spread operators to avoid RangeError limits on large datasets.
