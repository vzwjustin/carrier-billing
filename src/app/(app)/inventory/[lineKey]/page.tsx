...
export default async function InventoryLinePage({
  ...
  // ⚡ Bolt: Single-pass loop to find min and max without intermediate array allocations or spread operator
  ...
  const deltaCents =
    count >= 2 && minBase !== null && maxBase !== null ? maxBase - minBase : null;
