  ...
  return new ImageResponse(
    ...
    >
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 16, marginBottom: 'auto' }}>
        ...
        <div style={{ fontSize: 32, fontWeight: 700, letterSpacing: '-0.02em' }}>CarrierAudit</div>
      </div>
      ...
      >
        Upload Verizon, AT&T, or T-Mobile bills. AI extracts every line, 10 rules find the waste,
        you get a PDF report in under 5 minutes.
      </div>
